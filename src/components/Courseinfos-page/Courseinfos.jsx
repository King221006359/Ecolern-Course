import './infos.css'
// import imgcard1 from './src/image/cours2.jpg'
  ...
  return (
    ...
    <div className="Home-contain">
     ...
     <section className='about'>
        ...
        <br />
        <h4><strong>About the instructor</strong></h4><br /><br /><br />
        <div className='instructor'>
        <div className='left-sd'>
    
    {/* <img src ={imgcard1} className='loginstructor' /> */}
    ...
    <div className='right-sd'>
        ...
        <div className="about-content">
            ...
            <div className='image'>
           {/* <img src ={imgcard1} className='img' /><br /><br /> */}
